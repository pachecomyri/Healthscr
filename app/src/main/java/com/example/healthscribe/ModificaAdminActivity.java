...
public class ModificaAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifica_admin);

        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        refU= FirebaseDatabase.getInstance().getReference("Tablas").child("Usuario");

        etNomMod=(EditText)findViewById(R.id.txt_admin_nom);
        etApeMod = (EditText)findViewById(R.id.txt_admin_ape);
        etDniMod = (EditText) findViewById(R.id.txt_admin_dni);
        etEmailMod=(EditText)findViewById(R.id.txt_admin_email);
        etDirMod=(EditText)findViewById(R.id.txt_admin_dir);
        etPhoneMod=(EditText) findViewById(R.id.txt_admin_phone);
        etContMod=(EditText)findViewById(R.id.txt_admin_cont);


        Integer id = getIntent().getIntExtra("idAdmin",-1);
    ...
    public void modificarAdmin(View view){
        Integer id = getIntent().getIntExtra("idAdmin",-1);
        ...
        for(Usuario usuar:listaUs){
            if(usuar.getId().equals(id)){
                ...
                Toast.makeText(ModificaAdminActivity.this, "El usuario " + usuar.getId() + " ha sido modificado", Toast.LENGTH_LONG).show();
            }
        }
    }
